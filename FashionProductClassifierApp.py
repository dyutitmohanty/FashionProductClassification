...
# ======= CHECKPOINT LOADING =======
checkpoint_path = "checkpt_model.pth"
...
if uploaded_file is not None:
    ...
    intermediate_img_path = os.path.join(intermediate_folder, uploaded_file.name)
    ...
    st.subheader("Decoded Predictions:")
    for category, label in decoded_preds.items():
        st.write(f"**{category.capitalize()}**: {label}")